...
| [aws_iam_role.manifests_pin](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role) | resource |
| [aws_iam_role.manifests_read](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role) | resource |
...
| [aws_iam_role_policy.manifests_pin](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy) | resource |
| [aws_iam_role_policy.manifests_read](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy) | resource |
...
| [aws_iam_policy_document.manifests_pin_permissions](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/iam_policy_document) | data source |
| [aws_iam_policy_document.manifests_pin_trust](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/iam_policy_document) | data source |
| [aws_iam_policy_document.manifests_read_permissions](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/iam_policy_document) | data source |
| [aws_iam_policy_document.manifests_read_trust](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/iam_policy_document) | data source |
...
| <a name="input_gitops_repository"></a> [gitops\_repository](#input\_gitops\_repository) | Manifests repository allowed to check images in ECR from pull requests, and to tag promoted images from allowed branches. Null creates neither role. | `string` | `null` | no |
...
| <a name="output_gitops_pin_role_arn"></a> [gitops\_pin\_role\_arn](#output\_gitops\_pin\_role\_arn) | Role the manifests repository assumes on an allowed branch to tag promoted images. Null without gitops\_repository. |
| <a name="output_gitops_read_role_arn"></a> [gitops\_read\_role\_arn](#output\_gitops\_read\_role\_arn) | Role the manifests repository assumes, from pull requests too, to check that an image exists. Null without gitops\_repository. |
